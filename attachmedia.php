...
// check for select mode on clipboard
	...
	switch($clipboard_type) {
		case 'mediaattach_place':
			...
			$attach_type='place';
			$attachextra="pid";
			if(isset($places['currentauth'][_GWLOTO_USERAUTH_PL_EDIT])) $parmtest=($generic_id==$currentplace);
			break;
		case 'mediaattach_plan':
			...
			$attach_type='plan';
			$attachextra="cpid";
			if(isset($places['currentauth'][_GWLOTO_USERAUTH_CP_EDIT])) $parmtest=($generic_id==$currentplan);
			break;
		case 'mediaattach_point':
			...
			$attach_type='point';
			$attachextra="ptid";
			if(isset($places['currentauth'][_GWLOTO_USERAUTH_CP_EDIT])) $parmtest=($generic_id==$currentpoint);
			break;
		case 'mediaattach_job':
			...
			$attach_type='job';
			$attachextra="jid";
			if(checkJobAuthority($generic_id,$myuserid,true)) $parmtest=($generic_id==$currentjob);
			break;
		case 'mediaattach_jobstep':
			...
			$attach_type='jobstep';
			$attachextra="jsid";
			if(checkJobAuthority($currentjob,$myuserid,true)) $parmtest=($generic_id==$currentjobstep);
			break;
	}
