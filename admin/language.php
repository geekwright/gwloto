...
adminmenu(3);
	...
	$admin_uid=$myuserid;
	if(isset($_POST['admin_uid'])) $op = intval($_POST['admin_uid']);
	$language_name='';
	if(isset($_POST['language_name'])) $language_name = cleaner($_POST['language_name']);
	$language_code='';
	if(isset($_POST['language_code'])) $language_code = cleaner($_POST['language_code']);
	$language_folder='';
	if(isset($_POST['language_folder'])) $language_folder = cleaner($_POST['language_folder']);
	$language_id='';
	if(isset($_POST['language_id'])) $language_id = intval(cleaner($_POST['language_id']));
	$op='display';
	if(isset($_POST['op'])) $op = cleaner($_POST['op']);

	if($op != 'update' && $op != 'edit' && $op != 'add') $op='display';
