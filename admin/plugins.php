...
if (isset($_SESSION['UserLanguage'])) {
    ...
    if (isset($langfolders[$_SESSION['UserLanguage']])) {
        $language=$langfolders[$_SESSION['UserLanguage']];
    }
}
...
if (isset($err_message)) {
    echo '<strong>'.$err_message.'</strong>';
}
if (isset($message)) {
    echo '<em>'.$message.'</em>';
}
...
if ($cnt==0) {
    echo '<tr><td colspan="6" align="center">'._MI_GWLOTO_AD_PLUGINS_LISTEMPTY.'</td></tr>';
}
echo "</table>";
$dirname=$xoopsModule->getInfo('dirname');
