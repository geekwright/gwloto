    ...
    public function doPrint()
    {
        ...
        foreach ($this->jobsteps as $jobstepindex=>$jobstepdata) {
            ...
            $plandata=array();
                ...
                if ($plandata['hazard_inventory']=='') {
                    $plandata['hazard_inventory']=$placedata['place_hazard_inventory'];
                }
                if ($plandata['required_ppe']=='') {
                    $plandata['required_ppe']=$placedata['place_required_ppe'];
                }
                foreach ($placedata as $i=>$v) {
                    $jobstepdata[$i]=$v;
                }
                foreach ($plandata as $i=>$v) {
                    $jobstepdata[$i]=$v;
                }
